...
const AuditContent = () => {
    return (
        <div className="relative flex h-[100px] items-center px-[24px]">
            ...
            <div className="absolute left-0 md:left-[-60px] min-[1200px]:left-[-80px]">
                <img
                    src={icons.CERTIK_LOGO}
                    alt="certik logo"
                    className="w-[91.169px] h-[100px] md:w-[182.339px] md:h-[200px] min-[1200px]:h-[300px] min-[1200px]:w-[273.508px]"
                />
            </div>
            ...
            <div className="absolute right-0 md:right-[-60px] min-[1200px]:right-[-80px]">
                <img
            ...
            <div className="inline-flex items-center justify-center gap-[24px] md:gap-[60px] min-[1200px]:gap-[153px]">
                <img src={icons.homepage.audit1} alt="audit 1" className="md:w-[240px] min-[1200px]:w-[300px]" />
                <div className="h-[24px] border-[1px] border-[#24C3BC] md:h-[57px]"></div>
                <img src={icons.homepage.audit2} alt="audit 2" className="md:w-[240px] min-[1200px]:w-[300px]" />
            </div>
        </div>
    );
};
