...
const BannerContent = () => {
    return (
        <div className="flex flex-col items-center gap-[24px] md:max-w-[600px] md:px-0 min-[1200px]:max-w-[657px]">
            <div className="text-center text-[30px] font-bold leading-tight min-[1200px]:text-start min-[1200px]:text-[68px]">
            ...
            <div className="text-center text-[14px] md:text-[16px] font-normal text-[#C6C6C6] min-[1200px]:!text-start min-[1200px]:text-[18px]">
...
const BannerButtonDocument = () => {
    return (
        ...
        >
            <div className="text-[16px] font-bold text-white">Documentation</div>
        </a>
    );
};
            ...
            {cardItemInfo.map((item) => (
                <div key={item.id} className="flex items-start justify-between self-stretch">
                    <div className="flex h-[76px] flex-col items-center gap-1 rounded-[16px] py-[12px] min-[1200px]:items-start">
                        <div className="text-[16px] md:text-[24px] font-bold text-white min-[1200px]:text-[32px] leading-normal">
                            {item.title}
                        </div>
